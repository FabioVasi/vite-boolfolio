            ...
            <form action="" v-on:submit.prevent="sendForm()">
                ...
                <div v-if="!loading">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="tel" name="phone" id="phone" class="form-control" placeholder="Type your phone number here"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="email" id="email" class="form-control" placeholder="hello@example.com"
